...
čase dosáhnout vyšší produkce. Tomu říkáme zvyšování produktivity práce. Obětovaná příležitost.
	...
	\begin{itemize}
		\item Hmotné (jíst, bydlet, oblékat se...)
		\item Nehmotné (svoboda, přátelství, kulturní zážitek...)
		\item Zbytné (kaviár, loď...)
		\item Nezbytné (spánek, voda, vzduch...)
...
\begin{tabular}{| p{8cm} | p{8cm} |}
	\hline
		STATKY - určité předměty & SLUŽBY - cizí činnosti \\
	\hline
...
1) VÝROBA je činnost, při které člověk přetváří přírodu ve statky. Výrobu může provádět jednotlivec
nebo celé výrobní firmy.

K výrobě potřebují mít čtyři základní předpoklady - VÝROBNÍ FAKTORY.
A) PRÁCE-cenou je mzda

B) PŘÍRODNÍ ZDROJE-především půdu

C) KAPITÁL-je zisk nebo úrok

D) INFORMACE

A) PRÁCE je cílevědomá lidská činnost vytvářející statky a služby. Práce je vzácný výrobní faktor.
což ovlivňuje jeho cenu na trhu práce, tuto cenu nazýváme MZDOU.
MZDA REÁLNÁ = mzda, vypovídá o skutečné hodnotě výdělku, co si zaměstnanec může pořídit
MZDA NOMINÁLNÍ = mzda, kterou si pracovník vydělal jako zaměstnanec,
když vynaložil svou pracovní sílu, jeho příjem peněz

FAKTORY OVLIVŇUJÍCÍ VÝŠI MZDY: kvalifikace

poptávka na trhu práce

tržní úspěšnost
DĚLBA PRÁCE = jednotlivec nevyrábí všechno, soustředí se pouze na určitou výrobu,

jednotlivci jsou na sobě závislí

SPECIALIZACE = zaměření na určitý okruh činnosti
KOOPERACE = vzájemná spolupráce

B) PŘÍRODNÍ ZDROJE (PŮDA)
Při prodeji dosahuje vlastník tržní cenu.
Při nájmu dosahuje pozemkovou rentu.

POZEMKOVÁ RENTA:
a) absolutní renta — vyplývá z monopolu vlastnictví půdy a mají ji veškeré pozemky
b) diferenční renta — závislá na kvalitě půdy a její vhodnost pro zemědělství-bonita půdy

C) KAPITÁL-peníze přinášející další peníze
-má 2 ceny: ÚROK- je cena vloženého (např. do banky) kapitálu
ZISK- je cena, kterou očekává vlastník při aktivním podnikání

Hranice produkčních možností

= pokud společnost nemůže vyrábět se svými zdroji více určitých výrobků, aniž by snížila výrobu
jiných výrobků

= společnost vyrábí efektivně, pokud se pohybuje na hranici produkčních možností
\newpage
4
statek
v
...
Spotřeba je závěrečná fáze hospodářského procesu. Spotřebou statků a služeb uspokojujeme naše
potřeby.

SPOTŘEBA VÝROBNÍ
Je to spotřeba firem (stroje, kancelářský papír, materiál).

SPOTŘEBA KONEČNÁ
Je spotřeba lidí, občanů, domácností (jídlo, pití, bydlení).
\newpage
2. TRH A JEHO ZÁKONY
...
1. Podle územního hlediska: 2. Podle množství 3. Podle předmětu prodeje a koupě
zboží

a) místní (oblastní) - tvarůžky a) dílčí - trh mléka a) trh výrobních faktorů (trh práce)

b) národní - italská pizza b) agregátní b) finanční - kapitálový a peněžní

c) nadnárodní (EU) - ovoce -trh veškerého zboží | c) trh produktů (výrobků a služeb)
...
ZÁKONY TRHU
V tržním systému se ekonomické subjekty rozhodují v zásadě samy.
Chování tržních subjektů je však ovlivněno zákony trhu.
1. Zákon nabídky = s rostoucí cenou roste i nabídka zboží
= nabídkou rozumíme souhrn všech zamýšlených prodejů
2. Zákon poptávky = s rostoucí cenou klesá poptávka po zboží
= poptávkou rozumíme souhrn všech zamýšlených nákupů
...
e | Individuální (I kupující, | statek či služba)
e | Dílčí (poptávka všech lidí po určitém statku či službě)
e | Agregátní (všech lidí po všech statcích a službách)

Nabídku obdobně:
e | Individuální (1 výrobce určitého statku či služby)
e | Dílčí (nabídka všech výrobců určitého zboží)
e | Agregátní (nabídka všech výrobců, všeho druhu zboží)
...
e Cena
e © Demografické změny (v počtech a charakteristikách kupujících)
e © Změny velikosti důchodů (mzdy, renty vlastníků půdy, úroky a zisky vlastníků kapitálu)
e | Změny v preferencích (zvyky, móda, změny potřeb)
e © Změny cen jiných zboží
-substituty - jiné zboží, které může nahradit při spotřebě zboží sledované
(jablka - hrušky, čaj - káva)
-komplementy- jiné zboží, které doplňuje při použití zboží sledované
(auto — benzin, DVD přehrávač — DVD filmy)
FAKTORY OVLIVŇUJÍCÍ NABÍDKU:
e Cena
e © Náklady výroby a obchodu (dražší suroviny, energie, zvyšování mezd)
e © Změny vnějších podmínek podnikání (organizace trhu, počasí pro zemědělce, daně apod.)
e © Změny kapitálové výnosnosti


\newpage
INTERAKCE NABÍDKY A POPTÁVKY
e © Výrobci dopředu neznají rovnovážnou cenu a jí odpovídající ideální množství vyrobeného
zboží pro trh
e | Interakcí nabídky a poptávky získáváme rovnovážnou cenu a jí odpovídající množství statků

Rovnovážná cena

* Rovnovážným bodem tržní rovnováhy je ideální stav na trhu, kdy
se při rovnovážné ceně prodá vše, co se vyrobí.

Na trhu proto neexistuje ani přebytek ani nedostatek zboží (služeb).



cena P nabidka S

kvadrant převisu nabídky nad poptávkou
(zboží zůstává ve skladech a prodejnách)

rovnovážné | LL
cena P kvadrant převisu poptávky nad nabídkou
...
rovnovážné množství O“ množství O,

Obr. 8 Interakce nabidky a poptávky

Dokonalá konkurence
e | Výrobci mají rovné podmínky přístupu na trh
e | Kupující mají stejný přístup a jediným kritériem pro koupi či nekoupi je cena
e © V praxi skoro nenajdeme
Nedokonalá konkurence
e © Mezi potencionálními prodávajícími má jeden výsadní postavení na trhu
- administrativní monopol - jediný výrobce či prodejce má povolení od státu (Česká pošta)
- absolutní monopol - jediný výrobce zná recept na výrobu (Coca-cola, Kofola)
e | Výsadní postavení mezi poptávajícími, je výhradním nakupujícím-stát - monopsony
(speciální technologie, zbraně hromadného ničení)
Mlonopson — výsadní postavení určitého kupujícího na trhu

ČLENĚNÍ TRHU PODLE MÍRY KONKURENCE
e © Dokonalá konkurence
...
SELHÁNÍ TRHU
e | Zneužití výsadního postavení monopoly
e | Existence veřejných statků
e | Externality trhu
-negativní-špatný vliv výrobců na životní prostředí
-pozitivní-podnikatelská činnost může přinést i užitek (včelař zajišťuje opylení sadů a polí)
\newpage
SUBJEKTY TRHU

-domácnosti — přichází na trh za účelem uspokojení potřeb
-firmy - subjekty vyrábějící za účelem prodeje

-stát (vláda) - vstupuje na trh s cílem ovlivnit jej

TRŽNÍ ROVNOVÁHA = když se vyrovná nabídka a poptávka=stabilní situace na trhu
= důsledkem je rovnovážná cena na trhu

PŘEBYTEK - vzniká soutěž prodávajících, snižování cen, výroby atd., pokles nabízeného množství
NEDOSTATEK - zboží na trhu, typické pro ekonomiku plánovanou, vzniká soutěž kupujících, jsou
ochotní zaplatit 1 cenu vyšší, zvyšování ceny i při nekvalitních výrobcích

Tržní síly vedou k utváření rovnovážných cen, tím je určeno vyráběné množství výrobků (struktura
výroby)
\newpage
3. FIRMY A JEJICH FORMY

Právní osobnost = vzniká narozením a zaniká smrtí
= schopnost být nositelem práv a povinností (právní subjektivita)
Svéprávnost = způsobilost k právním úkonům — právně jednat (uzavírat smlouvy
= plná svéprávnost platí dovršením 18 let



FYZICKÉ OSOBY

- je jeden konkrétní člověk, který platí daň z příjmu

- podnikatelé podnikající na základě živnostenského či jiného oprávnění, zaměstnanci
- způsobilost podnikat nabývá dovršením 18 let

Členění fyzických osob:
I. Podnikatelé:
e | Podnikající na základě živnostenského oprávnění dle živnostenského zákona
e | Podnikající na základě jiného oprávnění dle jiných zákonů (lékaři, veterináři)
2. Zaměstnanci:
e | Osoby schopné vstupovat do pracovně právních vztahů se svými zaměstnavateli,
zde se řídíme především zákoníkem práce
3. Spotřebitel:
e | Spotřebitel je každý člověk, který sám uzavírá smlouvu s podnikatelem nebo s ním jedná
(NOZ)

PRÁVNICKÉ OSOBY

- je společnost několika osob, která je oprávněna vstupovat do právních vztahů a jednat
svým jménem
...
1. Korporace (obchodní korporace a spolky, politické strany)
2. Fundace (nadace a nadační fondy)

3. Ústavy (propojení majetkové a osobní složky)
...
- činnosti vyhrazené zákonem státu nebo určené právnické osoby

- využívání výsledků duševní tvůrčí činnosti (autorský zákon, vynálezy)

- povolání lékařů, veterinářů, advokátů, notářů, znalců, daňových poradců, makléřů

- činnost bank, pojišťoven, penzijních fondů, burz, pořádání loterií, hornická činnost,
výroba a rozvod elektřiny, plynu a tepla, zemědělství, provoz drah, telekomunikační
sítě, výroba léčiv, zprostředkovávání zaměstnání, výchova a vzdělávání ve školách ...

- pronájem nemovitostí, bytu a nebytových prostor

Všeobecné podmínky pro podnikání:
- plná svéprávnost (18 let a způsobilost k právním úkonům)

- bezúhonnost (dle výpisu z TR, který není starší více než 3 měsíce)

Zvláštní podmínky pro podnikání:



- odborná a jiná způsobilost (u řemeslných živností se požaduje vyučení v oboru)

Případy, kdy nelze provozovat činnost:

- když soud uložil podnikateli zákaz činnosti v oboru

- když na majetek podnikatele byl prohlášen konkurz

- podnikat nelze v případě, pokud návrh na konkurz byl zrušen pro nedostatek majetku

Emancipace - osvobození z podřízeného postavení, zrovnoprávnění
- boj za rovnoprávnost žen

Odpovědný zástupce je fyzická osoba ustanovená podnikatelem, která odpovídá za řádný provoz
živnosti a dodržování živnostenskoprávních předpisů a která je obvykle v pracovně právním nebo
jiném vztahu k podnikateli.
...
PO- jednají prostřednictvím statutárních orgánů (jednatel, představenstvo...)
...
-Další orgány družstva-zejména komise (mzdová, kulturní, rozhodčí, sociální...)
-Příklady družstev:
...
e | Morální (i fyzicky skvěle zachovalý stroj může být technicky zastaralý...)
Druhy odpisů:
...
© turbíny. výtahy. klimatizační zařízení, lodě...
4 20 let Domy a budovy ze dřeva a plastů. sila. tratě...
S 30 let Dálnice. silnice, plochy letišť, tunely. mosty...
6 50 let Budovy hotelů, obchodních domů, knihoven, muzei,
nh historické nebo kulturní památky...
...
Clenění materiálu (základní suroviny — stavební hmoty, kov, dřevo, kůže...)
...
Kancelářské potřeby — papíry, tužky, pásky do psacího stroje, šanony...
Čistící prostředky — pro hygienu zaměstnanců, úklid prostor...

Obaly a jejich funkce:
-plechovky, kartóny, plasty, palety, kontejnery, láhve...)
...
kamiónová doprava, lodní doprava, letecká doprava...)
...
množství a připravují se pro další činnosti: výdej do spotřeby...
...
e © Experiment (zjišťování reakce zákazníků na změnu ceny, reklamy, obalu...)
...
výrobku nebo služby. (podpora prodeje, reklama, personál...)
...
e © Materiál-zásoby nakoupené pro výrobu (suroviny,barvy,mazadla...)
e © Nedokončená výroba-materiál v různých fázích rozpracovanosti ,neprodej.
(roztavené železo ve slévárně...)
...
(soustruh,stojanová vrtačka...) — kontroluje jakost
...
Manipulace pomocí dopravních a zvedacích vozíků-ručních, elektrických...
...
e © Alokační-stát může poskytovat zvýhodnění (daňové úlevy)-očkování...
...
pro jednotlivce: pří úrazu, při dožití určitého věku, při léčení v cizině, ...
...
- předmět pojištění (na co smlouva je — na úraz, na majetek...)
